      ...
      <div class="right_col" role="main">
		...
		?>  <div class="row">
                    ...
                    <div class="container" style="background-color: #CDDCDC; background-image: radial-gradient(at 50% 100%, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%), linear-gradient(to bottom, rgba(255,255,255,0.25) 0%, rgba(0,0,0,0.25) 100%); background-blend-mode: screen, overlay;">
                        ...
                        <div style="background:#001394;padding:5px;margin:5px;border-radius: 7px;">
                            ...
                            <font color="white" size="3"><strong>Cotizacion:</strong></font>
                        </div>
                    ...
                    <form class="form-horizontal" role="form" id="datos_factura" action="cotizacion.php" method="get">
                        ...
                        <div class="form-group row" >
                          <div  class="col-md-1 col-sm-2 col-xs-12">Tipo Documento
                          ...
                          <option value="2" <?php echo $s2;?>><?php echo PJ;?></option>
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12" >Doc cliente
                              <div class="input-group">
                              <input class="form-control   textfield10" type="search" autocomplete="off"  name="doc1" id="doc1"  placeholder="<?php echo $dato;?>"  value="<?php echo $documento;?>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '11111111';}" required>
                               <span class="input-group-btn"><input  type="button" class="btn btn-primary " id="btn-ingresar" value="Buscar..." /></span>
                              </div>
                            </div>

                            <div class="col-md-3 col-sm-3 col-xs-12">Cliente
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">Dirección del cliente:
                        ...
                        <div class="form-group row" >
                            <div class="col-md-6 col-sm6 col-xs-12" >Teléfono
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12" >Email
       ...
       <div class="col-md-12">
         <div class="pull-right">
           <button type="button" class="css-button-4" data-toggle="modal" data-target="#myModal1"><span class="css-button-3-icon"><i class="glyphicon glyphicon-equalizer" aria-hidden="true" ></i></span><span class="css-button-3-text">Servicio</span></button>
           <button type="submit" class="css-button-3"> <span class="css-button-3-icon"><i class="glyphicon glyphicon-print" aria-hidden="true" ></i></span><span class="css-button-3-text">Imprimir</span></button>
			...
			<input  type="hidden" value="0" class="form-control input-sm" id="dias" name="dias" >
                        ...
                        <div class="container" style=" background: white; ">
                                <table class="table">
                                    <tr style="background-color: #CDDCDC; background-image: radial-gradient(at 50% 100%, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%), linear-gradient(to bottom, rgba(255,255,255,0.25) 0%, rgba(0,0,0,0.25) 100%); background-blend-mode: screen, overlay;">
                                        <td style="width:70%;">
