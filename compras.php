    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
		...
		<div class="panel-heading">
				...
				<a  href="nueva_compras.php" class="btn btn-info"><span class="glyphicon glyphicon-plus" ></span> Nuevo Doc</a>
			</div>
			<h4>Compras.</h4>
		</div>
				...
				<form style="color:black;" class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							...
							<div class="col-md-8 col-sm-8 col-xs-12">
                                                            Proveedor o # de doc
								<input type="text" class="form-control input-sm" id="q" placeholder="Nombre del Proveedor o # de doc " onkeyup='load(1);'>
							</div>
