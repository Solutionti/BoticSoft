 ...
 <div class="container">
	<div class="panel panel-info">
		<div class="panel-heading">
                    <h4><i class='glyphicon glyphicon-edit'></i> Nueva Guia </h4>
		</div>
  ...
  <form class="form-horizontal" role="form" id="datos_factura" action="listaguias.php">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12"  style="width:40%">ipo
              ...
              <div class="col-md-3 col-sm-3 col-xs-12"  style="width:20%">Motivo
              ...
              <div class="col-md-2 col-sm-2 col-xs-12"  style="width:20%">Serie<input class="textfield10" style="background-color:<?php echo COLOR1;?>;" type="text" class="form-control input-sm" id="serie" placeholder="Serie" value="ES" required readonly>
							</div>
    ...
    <div class="col-md-8">
					<div class="pull-right">
						<button type="button" class="btn btn-info" data-toggle="modal" data-target="#nuevoProveedores">
						 <span class="glyphicon glyphicon-user"></span>Agregar Proveedor
						</button>
						<button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModall">
                ...
                function agregar (id)
		{
		 ...
		 function Lector(n){
			...
			$.ajax({
                        ...
                        success: function(datos){
                        $( "#resultados" ).load( "ajax/agregar_entradas.php" );
                        }
			});
                        var x=13;
                        if(n.length >0) {
...
$(document).ready(function(){
    $("#condiciones").on('change', function () {
        $("#condiciones option:selected").each(function () {
            elegido=$(this).val();
            $.post("modelo2.php", { elegido: elegido }, function(data){
                $("#motivo").html(data);
            });
        });
   });
