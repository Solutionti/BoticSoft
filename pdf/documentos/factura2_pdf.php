...
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_factura VALUES (NULL,'0','$id_vendedor','$numero_factura','$condiciones','$id_producto','$cantidad','$precio_venta_r','$c','0','2','$date_added','0','$cond1','$d','$moneda1','$folio')");
        if($condiciones==2){
