  ...
  $tipo1="LISTA DE VENTAS";
    ...
    <table cellspacing="0" style="width: 100%; color: #001394" >
    	<tr>
          ...
          <tr><td align="center"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font style="color: #001394;"size="7"><strong>R.U.C.<?php echo $ruc;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><?php echo $tipo1;?></strong></font></td>
          </tr>
           </table>
           </td>
        </tr>
...
<tr class="border_bottom">
    <td style="width: 10%; " align="center" bgcolor="#001394"><strong style="color: #fff;font-size: 8pt;">ITEM</strong></td>
    <td style="width: 60%; " align="center" bgcolor="#001394"><strong style="color: #fff;font-size: 8pt;">DESCRIPCION</strong></td>
    <td style="width: 10%; " align="center" bgcolor="#001394"><strong style="color: #fff;font-size: 8pt;">CANTIDAD</strong></td>
		<td style="width: 10%; " align="center" bgcolor="#001394"><strong style="color: #fff;font-size: 8pt;">PRECIO</strong></td>
		<td style="width: 10%; " align="center" bgcolor="#001394"><strong style="color: #fff;font-size: 8pt;">IMPORTE</strong></td>
</tr>
<?php
...
<tr class="border_bottom1">
		...
		<td  height="10" align="center"><?php echo $row['cantidad']; ?></td>
		<td  height="10" align="center"><?php echo $row['precio_venta']; ?></td>
