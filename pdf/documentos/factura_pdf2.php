...
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "UPDATE detalle_factura set folio='$folio',numero_factura='$numero_factura',tipo_doc='$tipo' WHERE tienda=$tienda2 and folio='$folio1' and numero_factura='$num_fac' and tipo_doc=3 and ven_com=1");
...
$insert=mysqli_query($con,"UPDATE facturas set folio='$folio',numero_factura='$numero_factura',estado_factura='$tipo',fecha_factura='$date' WHERE tienda=$t1 and folio='$folio1' and numero_factura=$num_fac and estado_factura=3 and ven_com=1");
