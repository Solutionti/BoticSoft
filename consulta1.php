...
$insert=mysqli_query($con,"INSERT INTO consultas VALUES (NULL,'31','$a1','$a2','$a3','$a4','$a5','$a6')");
...
<head>
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>
 Reporte Ventas Clientes Mensual/anual
           ...
           <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                       <div class="x_panel" style="background:<?php echo COLOR;?>;">
                        <form style="color:black;" name="myForm" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="consulta1.php">

                          <div class="panel panel-info">
                                <div class="panel-heading">
                                <h2>Reporte Ventas Clientes Mensual/anual:</h2>
                                </div>
                        </div>
...
while($row=mysqli_fetch_array($rs)){
 ...
 <?php
    ...
    $sql="SELECT nombre_cliente,
SUM(if(YEAR(fecha_factura)=2017 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes1,
SUM(if(YEAR(fecha_factura)=2018 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes2,
SUM(if(YEAR(fecha_factura)=2019 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes3,
SUM(if(YEAR(fecha_factura)=2020 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes4,
SUM(if(YEAR(fecha_factura)=2021 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes5,
SUM(if(YEAR(fecha_factura)=2022 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes6,
SUM(if(YEAR(fecha_factura)=2023 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes7
