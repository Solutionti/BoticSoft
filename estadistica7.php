...
<head>
  ...
  <title>Reporte Dinámico Ingreso-Costo-Utilidad Mensual</title>
						...
						<div class="form-group row">
							...
							<div class="col-md-2 col-sm-2 col-xs-12">
								...
								<select class="form-control input-sm" id="q1"  onchange='load(1);'>
                                                                        ...
                                                                        <option value="1">Solo Ingreso</option>
                                                                        <option value="2">Solo Costo</option>
                                                                        <option value="3">Solo Utilidad</option>
...
$(document).ready(function(){
		...
		function load(page){
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'./ajax/buscar_estadistica5.php?action=ajax&page='+page+'&q='+q+'&q1='+q1+'&q2='+q2+'&q3='+q3+'&q4='+q4,
