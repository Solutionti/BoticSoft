...
<head>
  ...
  <title>Lista de ventas eliminadas.</title>
      ...
      <div class="right_col" role="main">
		...
		<div class="panel-heading">
			...
			<h4>Lista de Ventas eliminadas:</h4>
				...
				<form style="color:black;" class="form-horizontal" style="color:black;" role="form" id="datos_cotizacion">

						<div class="form-group row">

							<div class="col-md-6 col-sm-6 col-xs-12"  style="width:45%">
                                                                Buscar Cliente
