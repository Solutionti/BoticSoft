...
if($aa==0 && $accion>0){
    $insert=mysqli_query($con,"INSERT INTO guia(id_doc) VALUES ('$accion')");
}
...
?>
  ...
  <font style="color: #001394"><strong>RECEPCIONISTA/DOCUMENTO ASOCIADO:</strong></font>
  ...
  <font style="color: #001394"><strong>DATOS DE LA GUIA:</strong></font>
  ...
  <font style="color: #001394"><strong>DATOS DE PARTIDA/PESO/PAQUETES:</strong></font>
  ...
  <font style="color: #001394"><strong>DIRECCION DE DESTINO:</strong></font>
  <div class="form-group row">
  ...
  <font style="color: #001394"><strong>UNIDAD DE TRANSPORTE/CONDUCTOR:</strong></font>
  <div class="form-group row">
	<div class="col-md-4 col-sm-4 col-xs-12">
