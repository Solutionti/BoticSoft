  ...
  <div class="container body">
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			...
			include("modal/registro_pack.php");
			include("modal/editar_pack.php");
...
<script>
		...
		function load(page){
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'./ajax/buscar_pack.php?action=ajax&page='+page+'&q='+q,
...
$( "#guardar_pack" ).submit(function( event ) {
  $('#guardar_datos').attr("disabled", true);
  
 var parametros = $(this).serialize();
	 $.ajax({
			type: "POST",
			url: "ajax/nuevo_pack.php",
			data: parametros,
			 beforeSend: function(objeto){
...
$( "#editar_pack" ).submit(function( event ) {
  $('#actualizar_datos').attr("disabled", true);
  
 var parametros = $(this).serialize();
	 $.ajax({
			type: "POST",
			url: "ajax/editar_pack.php",
			data: parametros,
			 beforeSend: function(objeto){
