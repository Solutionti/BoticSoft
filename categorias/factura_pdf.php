...
$accion7=mysqli_query($con, "select * from detalle_factura where tipo_doc=$tipo and tienda=$tienda1 and folio='$folio' and ven_com=1 ORDER BY  `detalle_factura`.`id_detalle` DESC  LIMIT 0 , 1");
...
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_factura VALUES (NULL,'$id_cliente','$id_vendedor','$numero_factura','$des','$id_producto','$cantidad','$precio_venta_r','$c','$ddd','1','$date_added','$costo','$tipo','$d','$moneda1','$folio','$valor2','$valor3')");
