               ...
               <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                       <div class="x_panel" style="background:<?php echo COLOR;?>;">
                        <form  name="myForm" id="demo-form2" style="color:black;" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="consulta28.php">

                          <div class="panel panel-info">
                            <div class="panel-heading">
                                <h6>Libro de entradas y salidas</h6>
                            </div>
                        </div>
...
$sucursal_actual=$rs1["sucursal"];
    while($row=mysqli_fetch_array($rs)){
        ...
        <tr id="valor1">
            ...
            for($i=0;$i<=$j-1;$i++){
                ?>
                <td class=" "><a href="pdf/documentos/libro_entradas_salidas.php?fecha=<?php echo  $fec1[$i];?>&sucursal=<?php echo $sucursal_actual;?>&vendedor=<?php  echo $id_vendedoress;?>" target="_blank"><strong><?php echo $row[$fec[$i]];?></strong></a></td>
                <?php
            }
            ?>
        </tr>
