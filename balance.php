        ...
        if ($fecha2<>""){
            ...
            ?>
               <div class="row">
                   ...
                   <form name="myForm" style="color:black;" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="GET" action="balance1.php">
                  ...
                  <table id="example" class="display nowrap" style="width:100%;color:black;">
                    <thead>
                      <tr style="background-color:<?php echo tablas;?>;color:white; ">
                       <th>Fecha </th>
                       <th>Ventas <?php echo moneda;?></th>
                       <th>Compras <?php echo moneda;?></th>
...
for($i=$f1;$i<=$f2;$i++){
    $sql1="select * from detalle_factura where activo=1 and tienda>=$tienda1 and tienda<=$tienda2 and ven_com<=2 and tipo_doc<=3 and DATE_FORMAT(fecha, '%Y-%m-%d')>='$fecha1' and DATE_FORMAT(fecha, '%Y-%m-%d')<='$fecha2'";
...
if($fecha==$i*24*3600 && $tienda>=$tienda1 && $tienda<=$tienda2){
   if($ven_com==1 and $estado<=3){
       $total1=$total1+$venta*$moneda;
        $a1[$j]=$total1;
   }
   if($ven_com==2 and $estado<=3){
...
$j=$j+1;
     ...
     if($a>=1) {
        ...
        <tr id="valor1">
                        ...
                        <td class='text-right'><?php $total5=$total1-$total2;print" $total5";?></td>
...
?>
    ...
    <tr id="valor1">
                        ...
                        <td class='text-right'><strong><?php echo $total11;?></strong></td>
                        <td class='text-right'><strong><?php echo $total22;?></strong></td>
                        <td class='text-right'><strong><?php print" $total33";?></strong></td>
  ...
  <script>
    ...
    Morris.Bar({
       ...
       function imprimir(id_factura,tienda){
            ...
            window.open('utilidades.php?f='+id_factura+'&tienda='+tienda, "Detalle", "width=900, height=1000")
