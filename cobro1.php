    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
   	  <div class="modal-header" style="background: #58FAAC;">
		  ...
		  <div class="modal-body" style="background: #CED8F6;color:black;">
                      <form style="color:black;" class="form-horizontal" method="post" action="cobro2.php" id="nuevo_pagos" name="nuevo_pagos">
                         ...
                         <table class="table">
                             <thead>
                                 <tr style="background:#2E64FE;">
                                     ...
                                     <th style="width:20%;text-align:right;"><font color="white"  align="right"><strong>Pagar<?php echo moneda;?></strong></font></th>
         ...
         $total1=0;              
    $sql2="select * from facturas where id_cliente=$id and activo=1 and ven_com=1 and moneda=1";
    $i=0;
...
<?php
				...
				<td>
                                    <input type="number" style="border: 1px solid black;text-align:right;" step="0.1" min="0.1" autocomplete="off"  max="<?php echo $deuda1;?>" value="<?php echo 0;?>" id="spTotal" name="spTotal" required readonly="">
                                </td>
                                <td>
                        ...
                        <div class="form-group">
				<label for="codigo" class="col-sm-3 control-label">Nro Identidad</label>
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" autocomplete="off" style="background-color: #A9D0F5;" class="form-control" id="numero_factura" name="numero_factura" placeholder="Nro del documento" required>
				</div>
			</div>
