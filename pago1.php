  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        <h6 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> <font color="white">Realizar Pago </font></h6>
		  ...
		  <div class="modal-body" style="background: #CED8F6;">
			...
			<div id="resultados_ajax2"></div>
				...
				<input type="text" class="form-control cuadrosdetextocentro" id="mod_cliente" value="<?php echo $nombre;?>" name="mod_cliente" readonly>
        <input type="hidden" id="mod_id" name="mod_id" value="<?php echo $id;?>">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" class="form-control cuadrosdetextocentro" value="<?php echo $deuda1;?>" id="mod_deuda" name="mod_deuda" readonly>
				...
				<td>
                                    <input type="number"  class="cuadrosdetextocentro " step="0.1" min="0" autocomplete="off"  max="<?php echo $deuda1;?>" value="<?php echo 0;?>" id="spTotal" name="spTotal" required readonly="">
                                </td>
                                <td>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" autocomplete="off" class="form-control cuadrosdetextocentro" id="numero_factura" name="numero_factura" placeholder="Nro del documento" required>
				</div>
			  </div>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				 <select class="form-control cuadrosdetextocentro"  id="estado_factura" name="estado_factura" required>
					...
					<select class='form-control cuadrosdetextocentro' id="condiciones" name="condiciones" required>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
                                    <textarea  rows="4" class="form-control cuadrosdetextocentro" id="mod_obs" name="mod_obs"></textarea>
			...
			<?php
                        if($deuda1>0){
                            ?>
                            <button type="submit" class="btn btn-primary" id="actualizar_datos">Pagar</button>
                            <?php
                        }
                            ?>
		  </div>
