...
if($q4==">=1"){
 ...
 for($i=$f1;$i<=$f2;$i++){
     ...
     if($i<$f2){
         ...
         $text=$text." SUM(IF(DATE_FORMAT(fecha_factura, '%Y-%m-%d')='$fec[$j]' and ven_com=2 and estado_factura<=3 and activo=1 and facturas.tienda$tienda,total_venta,0)) AS '$fec1[$j]',";
     ...
     if($i<$f2){
         ...
         $text=$text." SUM(IF(DATE_FORMAT(fecha, '%Y-%m-%d')='$fec[$j]' and tipo_doc<=3 and ven_com=2 and activo=1 and detalle_factura.tienda$tienda,cantidad*precio_venta,0)) AS '$fec1[$j]',";
     }else{
         $text=$text." SUM(IF(DATE_FORMAT(fecha, '%Y-%m-%d')='$fec[$j]' and tipo_doc<=3 and ven_com=1 and activo=1 and detalle_factura.tienda$tienda,cantidad*precio_venta,0)) AS '$fec[$j]',";
         $text=$text." SUM(IF(DATE_FORMAT(fecha, '%Y-%m-%d')='$fec[$j]' and tipo_doc<=3 and ven_com=2 and activo=1 and detalle_factura.tienda$tienda,cantidad*precio_venta,0)) AS '$fec1[$j]'";
     }
