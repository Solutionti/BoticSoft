...
<?php
	...
	if (isset($_GET['id'])){
		...
		$query=mysqli_query($con, "select * from users where sucursal='".$id_categoria."'");
		$count=mysqli_num_rows($query);
		if ($count==0){
			if ($delete1=mysqli_query($con,"DELETE FROM sucursal WHERE id_sucursal='".$id_categoria."'")){
			?>
			...
			<div class="table-responsive">
			  <table class="table" style="color:black;">
				...
				while ($row=mysqli_fetch_array($query)){
                                        ...
                                        $descrip=$row['descripcion_sucursal'];
                                        $foto=$row['foto'];
                                        if($foto==""){
                                            $foto1="logo.jpg";
                                        }else{
                                        ...
                                        <input type="hidden" value="<?php echo $descrip;?>" id="descripcion<?php echo $id_sucursal;?>">
                                        ...
                                        <td><span class="pull-right">
                                            ...
                                            <a href="#" class='btn btn-danger btn-xs' title='Borrar Doc' onclick="eliminar('<?php //echo $id_sucursal; ?>')"><i class="glyphicon glyphicon-trash"></i> </a>
					</td>
					</tr>
					<?php
				}
