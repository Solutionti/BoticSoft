				...
				while ($row=mysqli_fetch_array($query)){
						...
						$estado_factura=$row['condiciones'];
                                                ...
                                                if ($ven_com==5){$text_estado1="Cobro";$label_class1='label-primary';}
																								if ($ven_com==15){$text_estado1="Otros gastos";$label_class1='label-primary';}
					...
					<tr id="valor1">
						...
						<td class='text-right'><?php print"$mon"; echo number_format ($total_venta,2); ?></td>
                                                ...
                                                <td class="text-right">
                                                <a href="#" class='btn btn-warning btn-xs' title='Editar Operación' onclick="obtener_datos('<?php echo $id_factura;?>');" data-toggle="modal" data-target="#myModal2"><i class="glyphicon glyphicon-edit"></i></a>
                                                <a href="#" class='btn btn-danger btn-xs' title='Borrar Operación' onclick="eliminar('<?php echo $id_factura; ?>')"><i class="glyphicon glyphicon-trash"></i> </a>
                                                <a href="#" class='btn btn-info btn-xs' title='Descargar ticket' onclick="imprimir_factura2('<?php echo $id_factura;?>');"><i class="glyphicon glyphicon-download"></i></a>
