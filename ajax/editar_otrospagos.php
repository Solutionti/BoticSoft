<?php
	...
	if (empty($_POST['mod_nombre'])) {
		...
		$sql="UPDATE facturas SET nombre='".$nombre."',ven_com='".$ven_com."',id_cliente='".$cliente."',condiciones='".$condiciones."',total_venta='".$pago."',estado_factura='".$estado_factura."',numero_factura='".$numero_factura."', obs='".$obs."' WHERE id_factura='".$id_factura."'";
