...
function limpiarFormulario() {
	...
	<body>
		<div class="modal fade" id="nuevoLaboratorio" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
		<div class="modal-content" style="background: #fff;">
		<div class="modal-header" style="background: #001394;color:#fff;">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		<h4 style="color:black;" class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> <font color="white">Agregar laboratorio</font></h4>
		</div>
		...
		<form style="color:black;" class="form-horizontal" method="post" id="guardar_laboratorio" name="guardar_laboratorio">


		<div class="form-group">
		<label for="nombre" class="col-sm-3 control-label">Nombre del laboratorio</label>
		<div class="col-sm-8">
		<input type="text" class="form-control" id="nom_laboratorio" name="nom_laboratorio" placeholder="Nombre del laboratorio" required>
		</div>
		</div>
