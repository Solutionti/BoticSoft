	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content" style="background: #fff;">
		  <div class="modal-header" style="background: #001394;color:black;">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 style="color:black;" class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i><font color="white"> Editar Sucursal</font></h4>
		  </div>
        ...
        <div class="form-group">
				...
				<textarea class="form-control" id="mod_ubigeo" name="mod_ubigeo" placeholder="Ubigeo" ></textarea>
				 ...
				 <div class="form-group">
				 <label for="mod_ubigeo" class="col-sm-3 control-label">Descripcion</label>
				 <div class="col-md-8 col-sm-8 col-xs-12">
