...
<body>
    ...
    <div class="modal-dialog" role="document">
      ...
      <h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i><font color="white"> Agregar nuevo Proveedor</font></h4>
		  </div>
      ...
      <div id="resultados_ajax"></div>
        ...
        <input  type="button" class="btn btn-success"  id="btn-ingresar" value="Buscar <?php echo PJ;?>/<?php echo PN;?> " />
				...
				<input type="number" min="1" autocomplete="off" class="form-control"  id="doc" name="doc" placeholder="Nro de Documento" >
				</div>
			  </div>
        ...
        <div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
        <input type="text" autocomplete="off"  class="form-control" id="nombre" name="nombre" placeholder="Razon Social" required>
				</div>
			  </div>
