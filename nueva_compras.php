...
$sql2=mysqli_query($con, "select * from detalle_factura where folio='$folio' and numero_factura=$numero_factura and tienda=$tienda1  and ven_com=12");
  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <div class="container" style="background-color: #CDDCDC; background-image: radial-gradient(at 50% 100%, rgba(255,255,255,0.50) 0%, rgba(0,0,0,0.50) 100%), linear-gradient(to bottom, rgba(255,255,255,0.25) 0%, rgba(0,0,0,0.25) 100%); background-blend-mode: screen, overlay;">
          ...
          <font color="white" size="3"><strong>COMPRAS:</strong></font><font color="white">LLenar campos obligatorios</font> <font style="background-color:#D8D8D8;color:white; "> &nbsp;&nbsp;&nbsp;&nbsp;</font>
          </div>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12" >Proveedor
            <div class="input-group">
            <input  type="search"  autocomplete="off" class="form-control cuadrosdetextocentro" name="doc1" id="nombre_proveedores"   placeholder="Selecciona un proveedor" value="<?php echo $nombre;?>" <?php echo $read;?> required>
          ...
          <div class="form-group row">
				  <div class="col-md-6 col-sm-6 col-xs-12" style="width:50%">Teléfono
          <input class=" form-control cuadrosdetexto" type="text" id="tel1" placeholder="Teléfono" value="<?php echo $telefono;?>" readonly>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12" style="width:50%">Email
          <input class="form-control cuadrosdetextoderecha" type="text" id="mail" placeholder="Email" value="<?php echo $email;?>" readonly>
          </div>
          </div>

          <div class="form-group row">
				  <div class="col-md-6 col-sm-6 col-xs-12" style="width:50%">
          Serie<input class="cuadrosdetexto form-control" style="background-color:<?php echo COLOR1;?>;" type="text" id="serie" placeholder="Serie" required>
				  </div>
          <div class="col-md-6 col-sm-6 col-xs-12" style="width:50%">
          Nro Doc<input class="form-control cuadrosdetextoderecha" style="background-color:<?php echo COLOR1;?>;" type="number" min="1"  id="factura" placeholder="Número de doc" required>
				  </div>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12" style="width:25%">
                                                            Tipo doc
								<select class="cuadrosdetexto form-control" style="background-color: <?php echo COLOR1;?>;" id="tipo_doc1">
				...
				<input  type="hidden" id="hora" value="<?php echo date("H:i:s");?>" required>
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12" style="width:25%">
                                    Requerimiento:
                                    <input class="cuadrosdetextocentro form-control" style="background-color: <?php echo COLOR1;?>;" type="text"  id="obs" name="obs" placeholder="Requerimiento" value="<?php echo $oc;?>" <?php echo $read;?>>
				</div>
                                <div class="col-md-2 col-sm-2 col-xs-12" style="width:20%">
                                    Pago
                                    <select class="cuadrosdetextocentro form-control" style="background-color: <?php echo COLOR1;?>;"  id="condiciones">
					...
					<option value="4">Crédito</option>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12" style="width:30%">
                                    Día pago Crédito
                                    <input class="form-control cuadrosdetextoderecha" style="background-color: <?php echo COLOR1;?>;" type="text"  id="dias" name="dias" placeholder="Nro días de crédito">
				</div>
                     ...
                     <div class="container" style=" background: white; ">
                                         <table class="table">
                                             <tr style="background:#001394;color:black;">
                                                 ...
                                                 <td style="width:30%;">
                                             <input  hidden type="text"    id="q5" placeholder="Codigo barras" onkeyup="Lector(this.value);">
