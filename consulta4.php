...
$insert=mysqli_query($con,"INSERT INTO consultas VALUES (NULL,'34','$a1','$a2','$a3','$a4','$a5','$a6')");
...
<head>
  ...
  <title>
  Tendencia de compras por productos mensual/anual
             ...
             <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                       <div class="x_panel" style="background:<?php echo COLOR;?>;">
                        <form style="color:black;" name="myForm" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="consulta4.php">
...
while($row=mysqli_fetch_array($rs)){
 ...
 <?php
$sql="SELECT nombre_producto,
SUM(if(YEAR(fecha)=2019 and ven_com=2 and activo=1 and detalle_factura.tienda=$tienda,cantidad*precio_venta,0)) AS mes1,
SUM(if(YEAR(fecha)=2020 and ven_com=2 and activo=1 and detalle_factura.tienda=$tienda,cantidad*precio_venta,0)) AS mes2,
SUM(if(YEAR(fecha)=2021 and ven_com=2 and activo=1 and detalle_factura.tienda=$tienda,cantidad*precio_venta,0)) AS mes3,
SUM(if(YEAR(fecha)=2022 and ven_com=2 and activo=1 and detalle_factura.tienda=$tienda,cantidad*precio_venta,0)) AS mes4,
SUM(if(YEAR(fecha)=2023 and ven_com=2 and activo=1 and detalle_factura.tienda=$tienda,cantidad*precio_venta,0)) AS mes5,
SUM(if(YEAR(fecha)=2024 and ven_com=2 and activo=1 and detalle_factura.tienda=$tienda,cantidad*precio_venta,0)) AS mes6,
SUM(if(YEAR(fecha)=2025 and ven_com=2 and activo=1 and detalle_factura.tienda=$tienda,cantidad*precio_venta,0)) AS mes7
FROM products, detalle_factura WHERE products.id_producto=detalle_factura.id_producto GROUP BY nombre_producto
";
