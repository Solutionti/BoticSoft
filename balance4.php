...
$sql="select * from facturas,clientes where facturas.activo=1 and facturas.tienda=$tienda and clientes.id_cliente=facturas.id_cliente and DATE_FORMAT(fecha_factura, '%d-%m-%Y')='$a'"; 
...
?>
            ...
            <table style="width:100%;color:black;" >
                  <tr><td style="width:25%;"><h3 style="color:blue;">Totales:</h3></td><td></td></tr>
                  <tr><td style="width:25%;"> <h2 style="color:blue;">Entrada:</h2></td>  <td class=" "><?php echo moneda;?><?php print" $total2";?></td></tr>
                  <tr><td style="width:25%;"> <h2 style="color:red;">Salida:</h2></td>    <td class=" "><?php echo moneda;?><?php print" $total4";?></td></tr>
                      
                   <tr><td style="width:25%;"> <h2 style="color:orange;">Diferencia:</h2></td>   <td class=" "><?php echo moneda;?><?php $dif2=$total2-$total4;print" $dif2";?></td></tr>
