...
//$sql="select * from products ORDER BY  `products`.`id_producto` DESC LIMIT 0 , 100";
 ...
 <?php   
    ...
    $sql="select * from facturas,clientes, users,pagos where facturas.id_cliente=clientes.id_cliente and facturas.id_vendedor=users.user_id and facturas.ven_com=1 and facturas.id_factura=pagos.id_factura and pagos.id_pago=$a"; 
