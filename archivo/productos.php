		...
		<div class="panel-heading">
			...
			<h4><i class='glyphicon glyphicon-search'></i>Productos en Sucursal<?php echo $_SESSION['tienda']; ?></h4>
                        ...
                        <form enctype="multipart/form-data" action="productos.php" method="POST">
                               ...
                               <input type="submit" class='btn btn-success btn-xs' value="cargar" disabled name="cargar"><font color=black>Boton se habilita al comprar para subir productos de forma masiva</font>
...
while (($datos =fgetcsv($productos,1000,",")) !== FALSE )//Leo linea por linea del archivo hasta un maximo de 1000 caracteres por linea leida usando coma(,) como delimitador
{
    ...
    $linea[]=array('codigo_producto'=>$datos[0],'nombre_producto'=>$datos[1],'costo_producto'=>$datos[2],'precio_producto'=>$datos[3],'marca'=>$datos[4],'modelo'=>$datos[5],'color'=>$datos[6],'b1'=>$datos[7],'b2'=>$datos[8],'b3'=>$datos[9],'b4'=>$datos[10],'b5'=>$datos[11],'b6'=>$datos[12],'min'=>$datos[13]);//Arreglo Bidimensional para guardar los datos de cada linea leida del archivo
