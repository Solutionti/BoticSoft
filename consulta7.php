...
$insert=mysqli_query($con,"INSERT INTO consultas VALUES (NULL,'37','$a1','$a2','$a3','$a4','$a5','$a6')");
...
<head>
  ...
  <title>
  Reporte Ventas Clientes Diario
           ...
           <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                       <div class="x_panel" style="background:<?php echo COLOR;?>;">
                        <form style="color:black;" name="myForm" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="consulta7.php">
        ...
        <table id="example" class="display nowrap" style="width:100%;color:black;">
                    <thead>
                      ...
                      <?php
                       for($i=0;$i<=$j-1;$i++){
                           ?>
                           <th style="width:5%;"><?php echo $fec1[$i];?></th>
                       <?php
                       }
                       ?>
