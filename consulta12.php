...
$insert=mysqli_query($con,"INSERT INTO consultas VALUES (NULL,'42','$a1','$a2','$a3','$a4','$a5','$a6')");
...
<head>
  ...
  <title>
  Tendencia de compras por vendedores diario:
               ...
               <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                       <div class="x_panel" style="background:<?php echo COLOR;?>;">
                        <form style="color:black;" name="myForm" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="consulta12.php">
                          ...
                          <div class="panel panel-info">
                            <div class="panel-heading">
                                ...
                                ?>
                                <h2>Tendencia de compras por vendedores diario:</h2>
                            </div>
                        </div>
...
$f2=$fech2/(24*3600);
 ...
 for($i=$f1;$i<=$f2;$i++){
     ...
     if($i<$f2){
         $text=$text." SUM(IF(DATE_FORMAT(fecha_factura, '%Y-%m-%d')='$fec[$j]' and ven_com=2 and activo=1 and facturas.tienda=$tienda,total_venta,0)) AS '$fec[$j]',";
        ...
        <tr id="valor1">
            <td class=" "><font color="black"><strong><?php echo $d;?></strong></font></td>
                <td class=" "><font color="blue"><strong><?php echo $suma;?></strong></font></td>
                       ...
                       for($i=0;$i<=$j-1;$i++){
                           ?>
                           <td align="right"><?php echo round($row[$fec[$i]],2);?>
                       <?php
                       }
                       ?>
                </td>
